<template>
  <div class="flex-1 py-6">
    <div class="bg-white px-4">
      ...
      <div>
        <h1 class="block text-2xl font-medium text-gray-700">Edit Classroom</h1>
      </div>
      <div class="pt-5">
      ...
      <div class="mt-4">
        ...
        >
          ...
          <span v-else>Edit Classroom</span>
        </button>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    index() {
      axios
        .get(`http://classroom.local/api/classroom/${this.id}`, {
          headers: {
    ...
    editClass() {
      ...
      axios
        .put(
          `http://classroom.local/api/classroom/${this.id}`,
          {
            name: this.name,
